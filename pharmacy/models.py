...
class Pharmacy(models.Model):
    ...
    latitude = models.FloatField(null=True, blank=True, help_text="Required: Pharmacy latitude coordinate")
    longitude = models.FloatField(null=True, blank=True, help_text="Required: Pharmacy longitude coordinate")
