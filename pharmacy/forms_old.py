...
class PharmacyRegistrationForm(forms.ModelForm):
    ...
    def clean_latitude(self):
        ...
        if latitude is None:
            raise ValidationError("Latitude coordinate is required for distance calculations.")
    ...
    def clean_longitude(self):
        ...
        if longitude is None:
            raise ValidationError("Longitude coordinate is required for distance calculations.")
